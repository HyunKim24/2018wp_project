...
module.exports = (app, io) => {
  ...
  // const connStr = 'mongodb://localhost/competition_db';
  // 아래는 mLab을 사용하는 경우의 예: 본인의 접속 String으로 바꾸세요.
  const connStr = 'mongodb://hyunmok:mju12345@ds123151.mlab.com:23151/competition_db';
  ...
  app.use('/', index);
  app.use('/users', users);
  app.use('/competitions', competitions(io)); // socket.io를 인자로 주기 위해 function으로 변경
